...
// App Service NSG
const appServiceNsg = new azure_native.network.NetworkSecurityGroup("appServiceNsg", {
...
// Databricks NSG
const databricksNsg = new azure_native.network.NetworkSecurityGroup("databricksNsg", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
// Key Vault NSG
const keyVaultNsg = new azure_native.network.NetworkSecurityGroup("keyVaultNsg", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
const privateEndpointNsg = new azure_native.network.NetworkSecurityGroup("privateEndpointNsg", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
const privateDnsZoneStorageBlob = new azure_native.privatedns.PrivateZone("privateDnsZoneStorageBlob", {
    resourceGroupName: resourceGroup.name,
...
const storageBlobVnetLink = new azure_native.privatedns.VirtualNetworkLink("storageBlobVnetLink", {
    resourceGroupName: resourceGroup.name,
...
const storagePrivateEndpoint = new azure_native.network.PrivateEndpoint("storagePrivateEndpoint", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
const storagePrivateDnsZoneGroup = new azure_native.network.PrivateDnsZoneGroup("storagePrivateDnsZoneGroup", {
    resourceGroupName: resourceGroup.name,
...
const privateDnsZoneKeyVault = new azure_native.privatedns.PrivateZone("privateDnsZoneKeyVault", {
    resourceGroupName: resourceGroup.name,
...
const keyVaultVnetLink = new azure_native.privatedns.VirtualNetworkLink("keyVaultVnetLink", {
    resourceGroupName: resourceGroup.name,
...
const keyVaultPrivateEndpoint = new azure_native.network.PrivateEndpoint("keyVaultPrivateEndpoint", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
const keyVaultPrivateDnsZoneGroup = new azure_native.network.PrivateDnsZoneGroup("keyVaultPrivateDnsZoneGroup", {
    resourceGroupName: resourceGroup.name,
...
const privateDnsZoneSql = new azure_native.privatedns.PrivateZone("privateDnsZoneSql", {
    resourceGroupName: resourceGroup.name,
...
const sqlVnetLink = new azure_native.privatedns.VirtualNetworkLink("sqlVnetLink", {
    resourceGroupName: resourceGroup.name,
...
const sqlPrivateEndpoint = new azure_native.network.PrivateEndpoint("sqlPrivateEndpoint", {
    resourceGroupName: resourceGroup.name,
    location: location,
...
const sqlPrivateDnsZoneGroup = new azure_native.network.PrivateDnsZoneGroup("sqlPrivateDnsZoneGroup", {
    resourceGroupName: resourceGroup.name,
...
const storageRoleAssignment = new azure_native.authorization.RoleAssignment("storageRoleAssignment", {
    scope: storageAccount.id,
    roleDefinitionId: pulumi.interpolate`/subscriptions/${azure_native.authorization.getClientConfigOutput().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/17d1049b-9a84-46fb-8f53-869881c3d3ab`,
    principalId: userObjectId,
    principalType: "User",
});

// SQL DB Contributor role for the user
const sqlRoleAssignment = new azure_native.authorization.RoleAssignment("sqlRoleAssignment", {
    scope: sqlServer.id,
    roleDefinitionId: pulumi.interpolate`/subscriptions/${azure_native.authorization.getClientConfigOutput().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/6d8ee4ec-f05a-4a1d-8b00-a9b17e38b437`,
    principalId: userObjectId,
    principalType: "User",
});
...
export const databricksWorkspaceUrl = databricksWorkspace.workspaceUrl.apply(url => `https://${url}`);
